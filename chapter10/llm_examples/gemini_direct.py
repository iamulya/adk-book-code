...
gemini_agent_auto = Agent(name="gemini_auto_resolver", model="gemini-1.5-flash-latest", instruction="You are Gemini.")
gemini_llm_instance = Gemini(model="gemini-1.5-flash-latest")
